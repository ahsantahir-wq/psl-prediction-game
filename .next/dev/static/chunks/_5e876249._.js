...
function LiveMatchFeed() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiveMatchFeed.useEffect": ()=>{
            loadMatches();
            const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('matches-changes').on('postgres_changes', {
                event: '*',
                schema: 'public',
                table: 'matches'
            }, {
                "LiveMatchFeed.useEffect.channel": ()=>loadMatches()
            }["LiveMatchFeed.useEffect.channel"]).subscribe();
            return ({
                "LiveMatchFeed.useEffect": ()=>{
    ...
    async function loadMatches() {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('matches').select('*').eq('status', 'live').order('match_date', {
            ascending: true
        });
        if (error) {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            match.batting_team && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
function PredictionModal({ match, onClose, onSuccess }) {
    ...
    const handleSubmitPrediction = async ()=>{
        ...
        try {
            ...
            const { data: wallet } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('wallet').select('credits_balance').eq('user_id', user.id).single();
            ...
            // Create prediction
            const { error: predictionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('predictions').insert({
                user_id: user.id,
                match_id: match.id,
            ...
            // Update user stats
            // Update user stats
            const { data: currentStats } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_stats').select('total_predictions, credits_spent').eq('user_id', user.id).single();
            if (currentStats) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_stats').update({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$LiveMatchFeed$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/LiveMatchFeed.tsx [app-client] (ecmascript)");
...
function Dashboard() {
    ...
    const [hasReset, setHasReset] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            ...
            const simulationInterval = setInterval({
                "Dashboard.useEffect.simulationInterval": async ()=>{
                    try {
            ...
            }["Dashboard.useEffect.simulationInterval"], 8000) // 8 seconds between each ball
            ;
            // Cleanup on unmount
            return ({
                "Dashboard.useEffect": ()=>clearInterval(simulationInterval)
            })["Dashboard.useEffect"];
        }
    }["Dashboard.useEffect"], []);
    const loadDashboard = async (shouldReset = false, loadMore = false)=>{
        try {
            ...
            if (shouldReset && !hasReset) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('matches').update({
                    status: 'live',
                    ball_number: 0,
                    current_score_a: 0,
                    current_wickets_a: 0,
            ...
            // Get wallet
            const { data: walletData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('wallet').select('*').eq('user_id', user.id).single();
            setWallet(walletData);
            // Get user stats
            const { data: statsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_stats').select('*').eq('user_id', user.id).single();
            setStats(statsData);
            ...
            if (favoritesData && favoritesData.length > 0) {
                ...
                const { data: matchesData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('matches').select('*').in('id', favoriteMatchIds).eq('status', 'live').order('match_date', {
                    ascending: true
...
_s(Dashboard, "2Wnzkh+bZJPVzjy4yu9XPyRs8AU=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=_5e876249._.js.map