...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        try {
            ...
            // Step 2: Auto-login
            const { error: loginError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
            ...
            if (user) {
                const { error: walletError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('wallet').insert({
                    user_id: user.id,
                    balance: 100
                });
                if (walletError) {
